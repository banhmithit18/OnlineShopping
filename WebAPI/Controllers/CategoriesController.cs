...
namespace WebAPI.Controllers
{
    ...
    public class CategoriesController : ControllerBase
    {
        ...
        [HttpGet("Search/{name}")]
        public async Task<ActionResult<IEnumerable<Category>>> SearchBrands(string name)
        {
            return await _context.Categories.Where(a => a.CategoryName.Contains(name)).ToListAsync();
        }
