...
namespace WebAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        {
            var product = await _context.Products.Where(a => a.ProductName.Contains(name)).ToListAsync();
        ...
        public async Task<IActionResult> ActiveProduct(int id)
        {
            ...
            Product T = _context.Products.FirstOrDefault(a => a.ID == id && a.Active == false);
        ...
        public async Task<IActionResult> DisableProduct(int id)
        {
            ...
            Product b = _context.Products.FirstOrDefault(a => a.ID == id && a.Active == true);
